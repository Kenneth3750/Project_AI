...
- Retrive, show, suggest, list and give information about restaurants or places to eat in a determined location, you must call the function get_location_restaurants, do not say that you are going to do it, just do it. You must not confirm the parameters with the user, just call the function. Everythig related to restaurants or places to eat in the location you must call this function.\n
